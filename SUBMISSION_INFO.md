# 提交到 Obsidian 社区插件的配置信息

## 添加到 community-plugins.json 的内容
...
Title: `Add plugin: Duplicate Note Finder`
...
Link to my plugin: https://github.com/iwwx/obsidian-duplicate-finder
